...
![image-20211209132814764](../images/image-20211209132814764.png)
...
![image-20211209133235343](../images/image-20211209133235343.png)

> 3.分库分表+水平拆分+Mysql集群

<img src="../images/image-20211209133955731.png" alt="image-20211209133955731"  />
...
![image-20211209140206051](../images/image-20211209140206051.png)
...
(../images/image-20211209141913786.png)

![image-20211209142032971](../images/image-20211209142032971.png)
...
![image-20220107101953465](../images/image-20220107101953465.png)
...
5. 再次make
   ...
   ![image-20220107142140385](../images/image-20220107142140385.png)
...
![image-20220107142659505](../images/image-20220107142659505.png)

7.确认redis安装是否完成

redis默认安装路径为 /usr/local/bin

![image-20220107142820799](../images/image-20220107142820799.png)
...
![image-20220107144109542](../images/image-20220107144109542.png)
...
![image-20220107144347667](../images/image-20220107144347667.png)
...
![image-20220107152351025](../images/image-20220107152351025.png)
...
![image-20220107152806271](../images/image-20220107152806271.png)
...
![image-20220107152840961](../images/image-20220107152840961.png)
...
![image-20220108162753113](../images/image-20220108162753113.png)
...
![image-20220108164255286](../images/image-20220108164255286.png)
...
![image-20220108164358105](../images/image-20220108164358105.png)
...
![image-20220123133111832](../images/image-20220123133111832.png)

查看某天是否打卡

![image-20220123133214635](../images/image-20220123133214635.png)



统计打卡天数

![image-20220123133243752](../images/image-20220123133243752.png)
...
![image-20220125215851123](../images/image-20220125215851123.png)
...
![image-20220208190446250](../images/image-20220208190446250.png)

1、配置文件 unit单位 对大小写不敏感

> 包含

![image-20220208190715250](../images/image-20220208190715250.png)
...
![image-20220208190907420](../images/image-20220208190907420.png)

2.端口和保护模式

![image-20220208191006207](../images/image-20220208191006207.png)
...
![image-20220208191230772](../images/image-20220208191230772.png)



![image-20220208191308195](../images/image-20220208191308195.png)

如果以后台的方式运行，我们就需要指定一个pid文件



![image-20220208191531726](../images/image-20220208191531726.png)
...
![image-20220210090620794](../images/image-20220210090620794.png)

默认数据库数量为16



![image-20220210090658335](../images/image-20220210090658335.png)
...
![image-20220210091208860](../images/image-20220210091208860.png)
...
![image-20220210100355001](../images/image-20220210100355001.png)
...
![image-20220210151928665](../images/image-20220210151928665.png)
...
![image-20220210152627577](../images/image-20220210152627577.png)
...
![image-20220210153152741](../images/image-20220210153152741.png)
...
![image-20220210164644355](../images/image-20220210164644355.png)

第一个:消息发送者，第二个:频道第三个:消息订阅者!

![image-20220210165448554](../images/image-20220210165448554.png)

> 命令

![image-20220210165521072](../images/image-20220210165521072.png)
...
![image-20220210170306411](../images/image-20220210170306411.png)
...
![image-20220211102713622](../images/image-20220211102713622.png)
...
![image-20220211103813232](../images/image-20220211103813232.png)
...
![image-20220211104018194](../images/image-20220211104018194.png)

修改pid，也该成对应的

![image-20220211104106137](../images/image-20220211104106137.png)

修改log文件，也不能重名！

![image-20220211104158742](../images/image-20220211104158742.png)

修改RDB文件名，避免重名

![image-20220211104236243](../images/image-20220211104236243.png)

### 启动服务

![image-20220211105300966](../images/image-20220211105300966.png)
...
![image-20220211110547105](../images/image-20220211110547105.png)
...
![image-20220211110927388](../images/image-20220211110927388.png)

slave1：

![image-20220211110946150](../images/image-20220211110946150.png)
...
![image-20220211165754621](../images/image-20220211165754621.png)
...
![image-20220126173026725](../images/image-20220126173026725.png)
...
![image-20220126175204964](../images/image-20220126175204964.png)

再次重新给dump.rbd赋权限

此时使用root用户启动redis就可以正常退出

![image-20220126175734671](../images/image-20220126175734671.png)

再开一个客户端使用自己的用户启动redis还是无法shutdown

![image-20220126175807169](../images/image-20220126175807169.png)

经过查找网站得知

https://blog.csdn.net/github_33809414/article/details/82531642

![image-20220126181618679](../images/image-20220126181618679.png)

可能是放dump.rdb文件的文件夹没有权限

给予bin目录所有权限后，自己的用户也可以正常退出了！

![image-20220126182033697](../images/image-20220126182033697.png)
...
![image-20220126182309441](../images/image-20220126182309441.png)
